...
// const MyDate = requires("./util/MyDate.js");
// const date = new MyDate();
// const currentTime = date.getTime();
// console.log(currentTime);

// document.getElementById("watch").innerHTML = '<p id="timer">' + currentTime +'</p>';

function setTheme(currentTime)
{
    if(currentTime >= 10)
        document.getElementById("Body").classList.add('themeNight');
    else
        document.getElementById("Body").classList.add('themeDay');
}
...
{
    const date = new MyDate();
    const currentTime = date.getTimeIn12();
    const currentDate = date.getDate();
    console.log(currentTime);

    setTheme(date.getHoures());

    document.getElementById("watch").innerHTML = '<p id="timer">' + currentTime +'</p>';
    document.getElementById("Cal").innerHTML = '<p id="timer">' + currentDate +'</p>';
    // document.getElementsByTagName("body").innerHTML = '<h1>'+currentTime+'</h1>'
}
